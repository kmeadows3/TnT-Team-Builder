...
public class ItemTests {
    ...
    @Test
    public void setEquipped_equips_item_if_unit_has_enough_hands() {
    ...
    public void setEquipped_throws_exception_when_unit_has_completely_full_hands() throws ValidationException{
    ...
    @Test (expected = ValidationException.class)
    public void setEquipped_throws_exception_when_unit_does_not_have_enough_hands() throws ValidationException{
        WEAPON.setEquipped(true);
